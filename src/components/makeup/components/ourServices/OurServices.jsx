...
const OurServices = () => {
  ...
  const header = state.makeupData.settings.header2;
  const text = state.makeupData.settings.text2;
  const image = state.makeupData.settings.image;
  const sectionStatus = state.makeupData.settings.section_4_status;
  useEffect(() => {
