...
const OurFoodServices = () => {
  ...
  const header = state.healthCareData.settings.header2;
  const text = state.healthCareData.settings.text2;
  const image = state.healthCareData.settings.image;
  const sectionStatus = state.healthCareData.settings.section_4_status;
  useEffect(() => {
