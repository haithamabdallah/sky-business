...
const OurServices = () => {
  ...
  const header = state.skinCareData.settings.header2;
  const text = state.skinCareData.settings.text2;
  const image = state.skinCareData.settings.image;
  const sectionStatus = state.skinCareData.settings.section_4_status;
  useEffect(() => {
