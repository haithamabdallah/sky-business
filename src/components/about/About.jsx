    ...
    aboutData.settings &&
        <div className="">
            <PageCover
                title=""
                subtitle=""
                backgroundImage={`${url}/${aboutData.settings.cover}`}
            />
            <div className="max-w-[1170px] mx-auto px-[15px] my-[3rem]">
                ...
                <div className="grid place-items-center grid-cols-1 lg:grid-cols-3 my-[3rem]">
                    <img src={`${url}/${aboutData.settings.images[3+1]}`} alt="image3" />
                    <div className="p-5 text-center font-[600]">
                        {parse(`${aboutData.settings.texts[3+1]}`)}
                    </div>
                    <img src={`${url}/${aboutData.settings.images[4+1]}`} alt="image4" />
                    <div className="p-5 text-center font-[600]">
                        {parse(`${aboutData.settings.texts[4+1]}`)}
                    </div>
                    <img src={`${url}/${aboutData.settings.images[5+1]}`} alt="image5" />
                    <div className="p-5 text-center font-[600]">
